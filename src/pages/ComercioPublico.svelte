...
<div class="publico-shell">
  ...
  <main class="pub-main">
    ...
    {:else if comercio}
      ...
      <!-- Dirección desde Firestore — dato central de verificación -->
      ...
      <div class="pub-instruccion">
        ...
        <p class="pub-instruccion-hint">
          Si las tres coinciden, el cartel es auténtico. Un cartel falsificado no puede mostrar la dirección correcta de Canasta.co.
        </p>
      </div>
      ...
      <div class="pub-ctas">
        ...
        <p class="pub-cta-hint">Canasta.co es gratis · Sin publicidad · Hecho en Argentina 🇦🇷</p>
      </div>
...
<style>
  ...
  .pub-tagline { font-size: 11px; color: rgba(255,255,255,0.65); font-weight: 500; }
  ...
  .pub-nombre {
    font-family: var(--f-brand); font-size: 20px; font-weight: 700;
  ...
  .pub-instruccion {
    background: rgba(27,107,58,0.06); border: 1px solid rgba(27,107,58,0.18);
    border-radius: var(--r-lg); padding: 16px;
  }
  .pub-instruccion-titulo { font-size: 13px; font-weight: 700; color: var(--c-primary); margin: 0 0 10px; }
  .pub-instruccion-pasos  { margin: 0 0 10px; padding-left: 18px; display: flex; flex-direction: column; gap: 6px; }
  .pub-instruccion-pasos li { font-size: 13px; color: var(--c-text); line-height: 1.45; }
  .pub-instruccion-hint { font-size: 11px; color: var(--c-text-mid); margin: 0; line-height: 1.5; font-style: italic; }
  ...
  .pub-token-spinner {
    width: 16px; height: 16px; border: 2px solid var(--c-border);
  ...
  .pub-precios-info {
    ...
    font-size: 12px; color: var(--c-text-mid); font-weight: 600; padding: 0 4px;
  }

  .pub-ctas { display: flex; flex-direction: column; gap: 12px; margin-top: 4px; }
  .pub-cta-primary {
    width: 100%; display: flex; align-items: center; justify-content: center; gap: 10px;
    padding: 16px; background: var(--c-primary); color: white; border: none;
    border-radius: var(--r-full); font-family: var(--f-ui); font-size: 15px; font-weight: 700;
    cursor: pointer; box-shadow: 0 4px 14px rgba(27,107,58,0.32); transition: opacity 0.15s;
